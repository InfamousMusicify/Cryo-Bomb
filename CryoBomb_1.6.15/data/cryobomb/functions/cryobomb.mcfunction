...
# Lava Cool
execute at @e[type=minecraft:armor_stand,tag=cryo_entity] as @s run fill ~-4 ~-7 ~-4 ~4 ~6 ~4 minecraft:stone replace minecraft:lava
execute at @e[type=minecraft:armor_stand,tag=cryo_entity] as @s run fill ~-5 ~-6 ~-5 ~5 ~5 ~5 minecraft:stone replace minecraft:lava
execute at @e[type=minecraft:armor_stand,tag=cryo_entity] as @s run fill ~-6 ~-5 ~-6 ~6 ~4 ~6 minecraft:stone replace minecraft:lava
# Water Freeze
...
# Viusals
execute at @e[type=minecraft:armor_stand,tag=o_cryo_entity] run particle minecraft:bubble_pop ~ ~.55 ~ 2 2 2 .000000000000000000001 7000 force
...
execute at @e[type=minecraft:armor_stand,tag=o_cryo_entity] run playsound minecraft:block.fire.extinguish master @a[distance=..25]
execute at @e[type=minecraft:armor_stand,tag=o_cryo_entity] run playsound minecraft:block.fire.extinguish master @a[distance=..25]
# Kill AS
