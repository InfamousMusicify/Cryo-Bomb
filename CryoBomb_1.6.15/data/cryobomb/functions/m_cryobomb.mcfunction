...
# Viusals
execute at @e[type=minecraft:armor_stand,tag=om_cryo_entity] run particle minecraft:bubble_pop ~ ~.55 ~ 2 2 2 .000000000000000000001 4000 force
execute at @e[type=minecraft:armor_stand,tag=m_cryo_entity] run particle minecraft:dolphin ~ ~.55 ~ 4 4 4 1 5000 force
execute at @e[type=minecraft:armor_stand,tag=therm_entity] run particle minecraft:poof ~ ~.55 ~ 2 2 2 1 125 force
...
execute at @e[type=minecraft:armor_stand,tag=om_cryo_entity] run playsound minecraft:block.fire.extinguish master @a[distance=..25]
